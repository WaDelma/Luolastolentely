...
/**
 * Hoitaa asioiden kirjanpidon
 *
 * @author aopkarja
 */
public class KirjanpidonHoitaja {

    /**
     * Ilmaisee väriä ANSI-koodilla
     *
     */
    public enum Vari {
     ...
     * @param object
     */
    public static void ilmoita(Object object) {
        StringBuilder rakentaja = new StringBuilder();
        asetaVari(rakentaja, Vari.SININEN);
        rakentaja.append(object);
     ...
     * @param exception
     */
    public static void ilmoita(Exception exception) {
        StringBuilder rakentaja = new StringBuilder();
        asetaVari(rakentaja, Vari.PURPPURA);
        rakentaja.append("Error: ");
        rekursiivinenIlmoitus(rakentaja, exception, 1, Vari.PUNAINEN);
