...
public class PelinLoppu extends Moodi {
    ...
    public PelinLoppu(Renderoija renderoija) {
        super(renderoija);
        lisaa(new SiirtymaPainike("Yritä uudestaan", Peli.class, PeliRenderoija.class, 400, 500, 100, 25, new PainikeRenderoija(), this));
        lisaa(new SiirtymaPainike("Valikko", Valikko.class, ValikkoRenderoija.class, 400, 450, 100, 25, new PainikeRenderoija(), this));
