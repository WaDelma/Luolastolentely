...
/**
 * Komponentti, jonka voi sijoittaa moodiin (kts. {@link aopkarja.UI.UIKasittelija}) tai
...
public abstract class Komponentti {
    ...
    public Renderoija getRenderoija() {
        return renderoija;
    }
    ...
    public final boolean aktiivinen() {
        return aktiivinen;
    }
    ...
    public List<Komponentti> getKomponentit() {
        return Collections.unmodifiableList(komponentit);
    }

    public final void setAktiivisuus(boolean aktiivisuus) {
